...
# Is there a better way to show this information?
# Are we sure this plot is correct?
# I commented out the code below because I got an error message that said:
# Error in likert(as.data.frame(data_increase)) : 
...
```{r}
# Ben Marwick's tip to use grid.arrange(), nest(), and map() to combine the pre/post plots
knowledge_pre <-
    c(
