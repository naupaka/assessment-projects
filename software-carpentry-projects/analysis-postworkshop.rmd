...
# Code by Kari and Ben (but mostly Ben ha!)
ordered_often <-
...
plot(lc_often_inst) +
  ggtitle("Perception of Instructors")
...
# looks right!
plot(lc_intim) +
  ggtitle("Respondent Perception of How Intimidating the Tools Covered were: Pre-Workshop")
