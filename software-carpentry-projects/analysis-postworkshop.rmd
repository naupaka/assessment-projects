...
```{r include=FALSE}
data <- read.csv("https://raw.githubusercontent.com/kariljordan/carpentry-community-assessment-projects/master/software-carpentry-projects/public_swc_preworkshop_data_archivedJune2017.csv", na.strings = "")
```
...
# The percentages on this plot are not showing correctly. Can someone fix it
