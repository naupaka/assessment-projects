...
kable(Contributed_Writing, format = "markdown", row.names = FALSE, col.names = c("Contributions to Academic Writing", "n"), caption = "Table 6: Respondents Perception of How Tools Contributed to Academic Writing")
```
...
We are very excited to know that our workshops are having an impact on learners 6 months to a year after the workshop. Though the results of this survey are compelling, we do notice areas of improvement. For example, 
