...
```{r, fig.cap=paste("Synopsis: Self-reported feeling of workshop impact for career advancement, motivation to learn, practicing reproducibility, receiving professional recognition, improving coding practices, improving research productivity, and gaining confidence as a result of completing a Carpentries workshop")}
